...
تم تجهيز المشروع ليدعم النشر المباشر على **Netlify**:

1. تأكد من ربط مستودع GitHub الخاص بك بـ Netlify.
...
## 📱 إشعارات الواتس آب (WhatsApp Notifications)

تم إضافة ميزة إبلاغ أولياء الأمور عبر الواتس آب بضغطة زر:

- **كيفية الاستخدام**: اذهب إلى صفحة "سجل الغياب" واضغط على أيقونة الواتس آب بجانب اسم الطالب الغائب.
- **تفعيل الميزة**: يجب ملء حقل "جوال ولي الأمر" في بيانات الطلاب.
- **التوسع التقني**: يمكن للمبرمجين مستقبلاً ربط واجهة برمجة التطبيقات (API) مثل Twilio أو Ultramsg لإرسال هذه الرسائل تلقائياً دون الحاجة لفتح التطبيق يدوياً.
