...
import { normalizeGhiyabiEmail, shouldFallbackToGoogleRedirect } from '../lib/authUtils';
...
export default function Login() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const loginIdentifier = normalizeGhiyabiEmail(email);
  ...
  const handleResetPassword = async () => {
    ...
    try {
      const fullEmail = normalizeGhiyabiEmail(normalizedResetEmail);
