...
import { normalizeLoginIdentifier, shouldFallbackToGoogleRedirect } from '../lib/loginIdentifier';
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export default function Login() {
  ...
  const handleResetPassword = async () => {
    ...
    try {
      await sendPasswordResetEmail(auth, normalizeLoginIdentifier(resetEmail));
