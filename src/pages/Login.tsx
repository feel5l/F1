...
import { normalizeGhiabiEmail } from '../lib/auth-helpers';
...
export default function Login() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const loginIdentifier = normalizeGhiabiEmail(email);
  ...
  const handleResetPassword = async () => {
    ...
    try {
      await sendPasswordResetEmail(auth, normalizeGhiabiEmail(normalizedResetEmail));
