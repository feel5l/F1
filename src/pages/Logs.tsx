...
import { buildAttendanceWhatsAppMessage, buildWhatsAppUrl } from '../services/notifications';
...
export default function Logs() {
  ...
  const sendWhatsAppNotification = (log: AttendanceLog, student?: Student) => {
    ...
    const message = buildAttendanceWhatsAppMessage(student.fullName, formattedDate);
