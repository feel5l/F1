...
import { computeAttendanceStats } from '../services/attendance';
...
export default function Attendance() {
  ...
  useEffect(() => {
    const fetchClasses = async () => {
      ...
      setClasses(filterClassesForUser(list, user?.email, isAdmin, staffMember?.appRole));
    };
  ...
  const stats = computeAttendanceStats(attendanceList);
